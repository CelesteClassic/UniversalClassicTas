...
function begin_game()
create_particles()
max_djump,deaths,frames,ms,seconds,minutes,time_ticking,new_bg,newer_bg,newest_bg,got_fruit=0,0,0,0,0,0,false,false,false,false,{}
music(13,0,7)
load_level(1)
end
function is_title()
...
player={
  ...
  update=function(this)
    ...
    if this.x<-4 and lvl_id==4 and max_djump==0 then
      load_level(14)
    end
    if this.x<-4 and lvl_id==13 then
      load_level(19)
    end
  ...
  draw=function(this)
    local v=((lvl_id==4 and max_djump==0) or (lvl_id==13 and max_djump==2)) and -5 or -1
...
fake_wall={
  ...
  draw=function(this)
    ...
    spr(64,this.x+8,this.y,1,2,true)
  end
}
...
function _update()
  ...
  if is_title() then
    if start_game then
      ...
      if start_game_delay<=-200 or start_game_delay<=-50 and btn(4) then
        if btn(4) then
          skip=true
        end
        title_offset=0
...
function _draw()
  ...
  if is_title() and start_game_delay and start_game_delay<=-40 then
    local c=1
    if start_game_delay>-150 and start_game_delay<-80 then
      c=7
    elseif start_game_delay>-160 and start_game_delay<-70 then
      c=6
    elseif start_game_delay>-170 and start_game_delay<-60 then
      c=5
    elseif start_game_delay>-180 and start_game_delay<-50 then
      c=0
    end
...
?two_digit_str(minutes/60)..":"..two_digit_str(minutes)..":"..two_digit_str(seconds).."."..two_digit_str(ms),x+1,y+1,7
end
...

...
__gff__

...

...

