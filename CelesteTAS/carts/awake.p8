...
tent={
  init=function(this)
    ...
    if false then
      ...
      cam_x=mid(spawn.x==-1 and this.x or spawn.x,64,lvl_pw-64)
				  cam_y=mid(this.y+32,64,lvl_ph-64)
      init_object(player,this.x+10,this.y).spr=0
      time_ticking=true
      ui_timer=5
    end
  end,
...
[13]="",
